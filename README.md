...
```
For evaluation, please download the reference batches for ImageNet (256x256 and 512x512) from [ADM](https://github.com/openai/guided-diffusion/tree/main/evaluations), and place them in the `./evaluator/` directory.
